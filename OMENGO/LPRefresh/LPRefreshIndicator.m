...
///主题颜色
#define LPRefreshMainColor(_alpha) [SM_lightBlueColor colorWithAlphaComponent:_alpha]
///图片路径
...
- (void)setRefreshing:(BOOL)refreshingBoolean
{
    refreshing = refreshingBoolean;
}
...
- (void)drawHeight:(CGFloat)h
{
    ...
    CGContextSetStrokeColorWithColor(ctx, SM_lightBlueColor.CGColor);
